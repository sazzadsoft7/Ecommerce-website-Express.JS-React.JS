...
import ProductsSkeleton from "../../components/skeleton/productsSkeleton.jsx"
                                    ...
                                    <div  className="card shadow-sm h-100 rounded-3 bg-white">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <p className="mt-3">
                                                ...
                                                <Link className="btn mx-2 btn-outline-success btn-sm" to={`/ProductDetails/${item['productID']}`}>Details</Link>
                                            </p>
                                        </div>
